...
local integer i=0
 ...
 //   call ExecuteFunc( "ClearArguments" )
  //  call ExecuteFunc( "ParseEnteredString" )
    ...
    call DisplayTextToPlayer(Player(i),0,0, "|cff800080" + "[" +  "Alien" +  "]|r" + udg_ColorCode[GetConvertedPlayerId(GetTriggerPlayer())]+ GetPlayerName(GetTriggerPlayer()) +  "|r: " + udg_arguments[2])
    endif
    set i=i+1
    endloop
endfunction
