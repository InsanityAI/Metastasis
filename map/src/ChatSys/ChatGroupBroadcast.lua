...
function Trig_ChatGroupBroadcast_Actions takes nothing returns nothing
    ...
    if ( IsPlayerInForce(GetTriggerPlayer(), udg_TempPlayerGroup) == true ) then
        ...
        call DisplayTextToForce( udg_TempPlayerGroup, ( "|cff808040" + ( ( "[" + ( udg_arguments[1] + ( "]|r" + udg_ColorCode[GetConvertedPlayerId(GetTriggerPlayer())]+ GetPlayerName(GetTriggerPlayer()) ) ) ) + ( "|r: " + udg_arguments[2] ) ) ) )
        call DisplayTextToForce( udg_DeadGroup, ( "|cff808040" + ( ( "[" + ( udg_arguments[1] + ( "]|r" + udg_ColorCode[GetConvertedPlayerId(GetTriggerPlayer())] + GetPlayerName(GetTriggerPlayer()) ) ) ) + ( "|r: " + udg_arguments[2] ) ) ) )
    endif
