if Debug then Debug.beginFile "Game/Spaceships/SSInit" end
OnInit.map("SSInit", function(require)
    function Trig_SSInit_Actions()
    ...
    --===========================================================================
    gg_trg_SSInit = CreateTrigger()
    TriggerAddAction(gg_trg_SSInit, Trig_SSInit_Actions)
end)
