function Trig_SSInit_Copy_Actions takes nothing returns nothing 
...
//=========================================================================== 
function InitTrig_SSInitJASS takes nothing returns nothing 
    set gg_trg_SSInitJASS = CreateTrigger() 
    call TriggerAddAction(gg_trg_SSInitJASS, function Trig_SSInit_Copy_Actions) 
endfunction 
