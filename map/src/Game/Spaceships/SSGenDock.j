...
function Trig_SSGenDock_Actions takes nothing returns nothing 
    ...
    if udg_TempUnit2 == gg_unit_h003_0018 then 
        ...
        endloop 
    elseif udg_TempUnit2 == gg_unit_h005_0024 then 
        //Defunct  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif udg_TempUnit2 == gg_unit_h007_0027 then 
        //Kyo station  
        set udg_TempBool = false 
    ...
    elseif udg_TempUnit2 == gg_unit_h009_0029 then 
        //U.S.I. Queen Niffy  
        set udg_TempBool = false 
    ...
    elseif udg_TempUnit2 == gg_unit_h00X_0049 then 
        //U.S.I. Swagger  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif udg_TempUnit2 == gg_unit_h008_0196 then 
        //Minertha  
        set udg_TempBool = false 
    ...
    elseif udg_TempUnit2 == gg_unit_h029_0114 then 
        //Lost station  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif udg_TempUnit2 == gg_unit_h02B_0116 then 
        //Pirate vessel  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif(udg_TempUnit2 == gg_unit_h03T_0209) then 
        //Errun  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif udg_TempUnit2 == gg_unit_h04T_0265 then 
        //Syllus  
        set udg_TempBool = false 
        ...
        loop 
            ...
            set bj_forLoopAIndex = bj_forLoopAIndex + 1 
        endloop 
    elseif GetUnitTypeId(udg_TempUnit2) == 'h04G' then 
        //MRZCODE: IF OVERLORD  
        set udg_TempBool = false 
