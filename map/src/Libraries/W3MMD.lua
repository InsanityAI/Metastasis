-- Instead of relying on this lib, maybe replace it with TH's codeless save/load?
-- if Debug then Debug.beginFile "Libraries/W3MMD"
-- ---------------------------------------------------------------
-- --- The Map Meta Data Library
-- --- Version: v1.00
-- --- Last Modified: April 24, 2009
-- --- Author Chain: Strilanc, Insanity_AI (converted to Lua)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- OnInit.module("Libraries/W3MMD", function (require)
--     globals
...
--     ---@param player player
--     ---@return string name
--     function GetPlayerNameO(player)
